 ...
 */
@DataObject(generateConverter = true, caseFormat = CaseFormat.LOWER_CAMEL)
public class LowerCamelCaseDataObject {
  ...
  public LowerCamelCaseDataObject(LowerCamelCaseDataObject copy) {
  }

  public LowerCamelCaseDataObject(JsonObject json) {
  }
