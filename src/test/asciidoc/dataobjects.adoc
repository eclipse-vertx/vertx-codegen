...
|[[addedUris]]`@addedUris`|`Array of link:dataobjects.html#URI[URI]`|-
...
|[[keyedUriValues]]`@keyedUriValues`|`link:dataobjects.html#URI[URI]`|-
...
|[[packagePrivateValue]]`@packagePrivateValue`|`Number (int)`|-
|[[protectedValue]]`@protectedValue`|`Number (int)`|-
...
|[[uri]]`@uri`|`link:dataobjects.html#URI[URI]`|-
|[[uriMap]]`@uriMap`|`link:dataobjects.html#URI[URI]`|-
|[[uriSet]]`@uriSet`|`Array of link:dataobjects.html#URI[URI]`|-
|[[uris]]`@uris`|`Array of link:dataobjects.html#URI[URI]`|-
|===
