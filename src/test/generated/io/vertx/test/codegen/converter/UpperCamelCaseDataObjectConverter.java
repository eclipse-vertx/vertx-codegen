...
/**
 * Converter and Codec for {@link io.vertx.test.codegen.converter.UpperCamelCaseDataObject}.
 ...
 */
public class UpperCamelCaseDataObjectConverter implements JsonCodec<UpperCamelCaseDataObject, JsonObject> {

  public static final UpperCamelCaseDataObjectConverter INSTANCE = new UpperCamelCaseDataObjectConverter();

  @Override
  public JsonObject encode(UpperCamelCaseDataObject value) {
  ...
  @Override public UpperCamelCaseDataObject decode(JsonObject value) { return (value != null) ? new UpperCamelCaseDataObject(value) : null; }

  @Override public Class<UpperCamelCaseDataObject> getTargetClass() { return UpperCamelCaseDataObject.class; }
