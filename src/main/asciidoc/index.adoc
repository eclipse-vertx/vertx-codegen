...
They are transformed to and from Json.

In its simplest form, a data object annotated type is a Java class following these rules:
...
For POJO to json object mapping, although there are no strict rules of mapping between the data object properties and the json structure, it is a good thing
