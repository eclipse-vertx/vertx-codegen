...
public class EnumModel implements Model {
  ...
  public EnumModel(ProcessingEnvironment env, TypeElement modelElt) {
    ...
    this.typeMirrorFactory = new TypeMirrorFactory(elementUtils, typeUtils, ModuleInfo.resolveFirstModuleGenAnnotatedPackageElement(elementUtils, elementUtils.getPackageOf(modelElt)));
