...
public abstract class Token {
  ...
  public static Function<Token, Token> tagMapper(
    ...
    TypeMirrorFactory typeFactory = new TypeMirrorFactory(elementUtils, typeUtils, ModuleInfo.resolveFirstModuleGenAnnotatedPackageElement(elementUtils, elementUtils.getPackageOf(ownerElt)));
    return token -> {
